...
export default function Navbar() {
  ...
  // Track scroll position to update active navigation links instantly on scroll
  useEffect(() => {
    const handleScroll = () => {
      const scrollPosition = window.scrollY + 110; // Matches navbar height + margin offsets
    ...
    <header className="header">
      <div className="nav-container container">
        ...
        <a href="#home" className="logo-container" onClick={e => go(e, '#home')} aria-label="FreshCanopy – back to top">
          <img src={logo} alt="FreshCanopy Tree Care Logo" className="logo-img" />
